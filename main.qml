...
//    }
    ...
    MasonryLayout {
        ...
        MouseArea {
            ...
            onWheel: (wheel) => {
                         ...
                         var newContentY = (scrollAnimation.running ? scrollAnimation.to : masonryLayout.contentY) - deltaCell
                         newContentY = Math.max(0, Math.min(masonryLayout.contentHeight - masonryLayout.height, newContentY))
                         scrollAnimation.from = masonryLayout.contentY
                         scrollAnimation.to = newContentY
                         scrollAnimation.restart()
                     }
    ...
    Slider {
        ...
        onValueChanged: masonryLayout.targetHeight = zoomSlider.value
    }
