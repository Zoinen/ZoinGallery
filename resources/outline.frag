...
void main() {
    ...
    fragColor = mix(outlineColor, sourceColor, sourceColor.a) * qt_Opacity;
    fragColor.a = max(sourceColor.a, outline) * qt_Opacity;
}
*/
...
void main() {
    ...
    fragColor = mix(outlineColorWithOpacity, sourceColor, sourceColor.a) * qt_Opacity;
    fragColor.a = max(sourceColor.a, outline * outlineOpacity) * qt_Opacity;
}
*/
...
void main() {
    ...
    // Combine blur, outline, and text
    fragColor = mix(blurColorWithOpacity, outlineColorWithOpacity, outline);
    fragColor = mix(fragColor, sourceColor, sourceColor.a);
    fragColor.a = max(max(sourceColor.a, outline * outlineOpacity), blur * blurOpacity);
